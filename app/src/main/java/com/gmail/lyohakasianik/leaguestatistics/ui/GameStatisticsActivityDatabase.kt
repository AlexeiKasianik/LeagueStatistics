...
class GameStatisticsActivityDatabase : FragmentActivity() {
    ...
    override fun onCreate(savedInstanceState: Bundle?) {
        ...
        buttonAddGameInStatistic.setOnClickListener {
            viewModel.removeGameInDatabase(idGame)
            Toast.makeText(this, "Игра была удалена из статистики", Toast.LENGTH_LONG).show()
